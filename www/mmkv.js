...
window.mmkv = {
    ...
    init: function(success,failure,rootDir) {
        exec(success,failure,"MMKVPlugin","init",[rootDir]);
    },
    /**
    ...
    create: function(success,failure,mmkvId) {
        exec(success,failure,"MMKVPlugin","create",[mmkvId]);
    },
    /**
    ...
    close: function(success,failure,mmkvId) {
        exec(success,failure,"MMKVPlugin","close",[mmkvId]);
    },
    /**
     * destroy mmkv.
     * @param {function} success Callback function
    ...
    destroy: function(success,failure) {
        exec(success,failure,"MMKVPlugin","destroy",[]);
    },
    /**
     * read a key's value.
     * @param {function} success Callback function
    ...
    read: function(success,failure,mmkvId,key) {
        exec(success,failure,"MMKVPlugin","read",[mmkvId,key]);
    },
    /**
     * write a kv to disk.
     * @param {function} success Callback function
    ...
    write: function(success,failure,mmkvId,key,value) {
        exec(success,failure,"MMKVPlugin","write",[mmkvId,key,value]);
    },
    /**
     * erase(delete) a kv.
     * @param {function} success Callback function
    ...
    erase: function(success,failure,mmkvId,key) {
        exec(success,failure,"MMKVPlugin","erase",[mmkvId,key]);
    },
    /**
    ...
    contain: function(success,failure,mmkvId,key) {
        exec(success,failure,"MMKVPlugin","contain",[mmkvId,key]);
    },
    /**
     * get mmkv file size.
     * @param {function} success Callback function
    ...
    fileSize: function(success,failure,mmkvId) {
        exec(success,failure,"MMKVPlugin","fileSize",[mmkvId]);
    },
    /**
    ...
    count: function(success,failure,mmkvId) {
        exec(success,failure,"MMKVPlugin","count",[mmkvId]);
    },
    /**
    ...
    valueSize: function(success,failure,mmkvId,key) {
        exec(success,failure,"MMKVPlugin","valueSize",[mmkvId,key]);
    },
    /**
    ...
    trim: function(success,failure,mmkvId) {
        exec(success,failure,"MMKVPlugin","trim",[mmkvId]);
    },
    /**
     * clear all kv.
     * @param {function} success Callback function
